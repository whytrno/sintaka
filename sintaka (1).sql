...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Nov 2021 pada 16.59
...
(1, 'cawd1', 'casdaw2', '<p>                          <span style=\"color: rgb(34, 34, 34); font-family: Verdana, BlinkMacSystemFont, -apple-system, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 15px; background-color: rgb(255, 255, 255);\">3Sudah sejak lama pertanyaan “apa sebenarnya One Piece?” atau “harta karun misterius apa yang sosok Gol D. Roger tinggalkan untuk mereka yang menemukannya?” terdengar di kalangan pecinta seri ini. Karena harta karun ini masih sangat misterius (bahkan kita belum tahu bentuknya seperti apa), banyak orang yang kemudian berspekulasi tentang hal tersebut. Berikut adalah beberapa spekulasi tentang One Piece</span></p><p><span style=\"color: rgb(34, 34, 34); font-family: Verdana, BlinkMacSystemFont, -apple-system, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 15px; background-color: rgb(255, 255, 255);\">Hayoooo</span></p>', 'about-logo.jpeg', NULL, '2021-11-14 07:50:04');
...
(29, 1, 'dddaaa', 'awdadasdawd', 'dwdad', 'dawdadsadw', 'adawd', 'GM67eP2ywfgNq5ojgIBsTNSAseJkM5Z3k8iBZmPX.jpg', '2021-11-14 08:17:16', '2021-11-14 08:17:16');
...
(32, 'awdawd', 'dwad', 'adw', '2021-11-11', '2021-11-12', 'asdwa', NULL, NULL),
(33, '13', 'va', 'w', '2021-11-15', '2021-11-19', 'faw', NULL, NULL);
...
INSERT INTO `infos` (`info_id`, `info_title`, `info_desc`, `info_image`, `created_at`, `updated_at`) VALUES
(19, 'asdasd1', 'awd', 'olq3injek0sOstiQSPqzJjt0eCcPgiKg6n16shri.jpg', '2021-11-11 21:29:26', '2021-11-11 21:29:26'),
(20, 'ca', 'wd', 'v6zOtTXguQt2PSoYyhI6bk4kV8vuxjWANR4JnQMv.png', '2021-11-11 21:32:09', '2021-11-11 21:32:09'),
(21, 'vs', 'w', 'ZnBbDtkujhNc0FR92RWjPcQySxylTOBdWxR3uci7.png', '2021-11-11 21:33:45', '2021-11-11 21:33:45'),
(22, 'cadawdawd', 'awdawdawdawdawdwdad', '94GcNTFMTY35KmkYzlFk2jVDhjaQvmMtNMGjpWmC.png', '2021-11-11 22:29:54', '2021-11-11 22:29:54'),
(23, 'awdddddddddddd', 'awaaaada', 'LeX0VDDDAZ6wHbZFvLD9acFVzEqESDFdSfYiRNEj.jpg', '2021-11-11 22:30:41', '2021-11-11 22:30:41'),
(24, 'cvbcvbc', 'vbcvbcbvcb', 'SMBSitbx9BA3rw0Wno2l0SbVQLoIU57ZBKd4XQbM.jpg', '2021-11-11 22:31:58', '2021-11-11 22:31:58');
...
(22, '2021_11_14_150139_create_services_table', 13);
...
(2, 'awda', 'wawwwwwww', '2021-11-14 08:20:12', '2021-11-14 08:20:12'),
(3, 'awdaw', 'adwad', '2021-11-14 08:23:50', '2021-11-14 08:23:50'),
(4, 'awdawd', 'adwawdawdwadad', '2021-11-14 08:24:00', '2021-11-14 08:24:00'),
(5, 'vvvvvvvvvvv', 'aaaaaaaaaaa', '2021-11-14 08:24:12', '2021-11-14 08:24:12');
...
(1, 'Bambang1', 'Wah bagus banget2', NULL, '2021-11-14 08:18:08'),
...
(2, 'Bambang', 'admin@admin.com', NULL, '$2y$10$0ikDR0l3ze0DrhEkj5movux49SClPNR9wm.SkAdetsPNxfY4.JBEC', 'HYki62FISkTEtTFsAyCIIDKr8uVWdHW5OBE75Jd4UvoSChpuBbDOaVBkLdr0', '2021-11-07 22:52:36', '2021-11-09 05:01:00'),
...
--
ALTER TABLE `destinations`
  MODIFY `destination_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `events`
  MODIFY `event_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT untuk tabel `infos`
--
ALTER TABLE `infos`
  MODIFY `info_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
